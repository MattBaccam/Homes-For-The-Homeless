...
namespace WpfPresentation
{
    ...
    public partial class MainWindow : Window
    {
        ...
        /// Creator: Ethan McElree       
        /// Created: 02/15/2024
        /// Summary: Click handler for navigating to the create a schedule page.
        /// Last Updated By: Ethan McElree
        /// Last Updated: 02/15/2024
        /// What Was Changed: Inital creation
        /// </summary>
        ...
        {
            FrameLoad.Navigate(pgCreateSchedule.GetpgCreateSchedule());
        }
        ...
        private void btnPasswordStrength_Click(object sender, RoutedEventArgs e)
        {
            FrameLoad.Navigate(PgPasswordStrength.GetPgPasswordStrength());
        }
